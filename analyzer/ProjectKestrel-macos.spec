...
datas = [('models', 'models'), ('gui_app.py', '.'), ('folder_inspector.py', '.'), ('gui_helpers.py', '.'), ('cli.py', '.'), ('VERSION.txt', '.'), ('kestrel_analyzer', 'kestrel_analyzer'), ('visualizer.html', '.'), ('logo.png', '.'), ('logo.ico', '.')]
binaries = []
